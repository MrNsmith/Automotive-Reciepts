...
import { StepForwardOutlined, CarFilled , RedoOutlined} from "@ant-design/icons";
class ShopExpense extends Component {
  ...
  addInfo = () => {
    const { vehicleChoice, otherInput } = this.state;
    this.props.getInfo2Vh(["N/A"]);
    this.props.getInfo2Ex([`${vehicleChoice} ${otherInput}`]);
    this.props.getInfo4(["N/A"]);
    ...
    return (
      ...
      <div>
        ...
        >
          ...
          <label>Shop/Fleet Expense:</label>
            <Form.Item
              name="Vehicle"
              className="choice"
              rules={[
...
export default connect(null, { getInfo2Ex, getInfo2Vh,getInfo4  })(ShopExpense);
